(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddStopComponent = /** @class */ (function () {
                function AddStopComponent(dialogRef) {
                ...
                AddStopComponent.prototype.ngOnInit = function () { };
                AddStopComponent.prototype.handleStopPlaceChange = function (place) {
                    this.stopCity = place;
                    console.log(place);
                };
                AddStopComponent.prototype.handleArrivalTimeSet = function (time) {
                    this.arrivalTime = time;
                };
                AddStopComponent.prototype.handleDepartureTimeSet = function (time) {
                    this.departureTime = time;
                };
                AddStopComponent.prototype.getMinDate = function () {
                    return new Date(Date.now());
                };
                AddStopComponent.prototype.handleArrivalDateSet = function (date) {
                    this.arrivalDate = new Date(date.value);
                    console.log(this.arrivalDate);
                };
                AddStopComponent.prototype.handleDepartureDateSet = function (date) {
                    this.departureDate = new Date(date.value);
                    if (this.departureDate < this.arrivalDate) {
                    }
                };
                AddStopComponent.prototype.closeDialog = function () {
                    this.dialogRef.close();
                };
                AddStopComponent.prototype.addStop = function () {
                    var stop = {
                        location: {
                ...
                return AddStopComponent;
            }());
            AddStopComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HotelCardListComponent = /** @class */ (function () {
                function HotelCardListComponent(httpService, tripService) {
                    var _this = this;
                    ...
                    this.httpService
                        ...
                        console.log(data);
                        _this.arrHotels = data["hotels"]; // FILL THE ARRAY WITH DATA.
                    }, function (err) {
                        console.log(err.message);
                    });
                }
                HotelCardListComponent.prototype.ngOnInit = function () { };
                HotelCardListComponent.prototype.hotelByStop = function (stop) {
                    var _this = this;
                    this.httpService
                ...
                return HotelCardListComponent;
            }());
            HotelCardListComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MapComponent = /** @class */ (function () {
                function MapComponent(tripService) {
                    this.tripService = tripService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlannerComponent = /** @class */ (function () {
                function PlannerComponent(route, tripService, http, dialog) {
                    this.route = route;
                    this.tripService = tripService;
                    this.http = http;
                    this.dialog = dialog;
                ...
                PlannerComponent.prototype.ngOnInit = function () {
                    ...
                    this.http.get("http://3.14.69.62:5000/api/trip/" + id).subscribe(function (data) {
                        _this.tripService.trip = data;
                    });
                    // console.log(this.route.params["value"]);
                };
                PlannerComponent.prototype.openDialog = function () {
                    var _this = this;
                    ...
                    var dialogRef = this.dialog.open(_add_stop_add_stop_component__WEBPACK_IMPORTED_MODULE_6__["AddStopComponent"], dialogConfig);
                    dialogRef.afterClosed().subscribe(function (stopFromDialog) {
                        console.log(stopFromDialog);
                        _this.addStop(stopFromDialog);
                    });
                };
                PlannerComponent.prototype.addStop = function (stop) {
                    // let stopToAdd=this.generateStop(stop);
                    this.tripService.addStopToTrip(stop);
                };
                PlannerComponent.prototype.closeDialog = function () {
                    this.dialog.closeAll();
                };
                return PlannerComponent;
            }());
            PlannerComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TimelineComponent = /** @class */ (function () {
                function TimelineComponent(tripService) {
                    this.tripService = tripService;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TripService = /** @class */ (function () {
                ...
                TripService.prototype.handleDirectionResponse = function (directionResult) {
                    if (directionResult.routes[0].legs[0]) {
                        var destinationArrival = new Date(this.trip.destination.arrival);
                ...
                TripService.prototype.addStopToTrip = function (stop) {
                    this.trip.stops.push(stop);
                    // console.log("Updated stops array");
                    // console.log(this.trip.stops);
                    this.updateWaypoints();
                };
                TripService.prototype.updateWaypoints = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                ...
                HeaderComponent.prototype.onResize = function (eventData) {
                    this.displayIcon = !((eventData.target.innerWidth - 1 + 1) > 615);
                    this.optionsOverlay = false;
                };
                HeaderComponent.prototype.showOptions = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PlaceAutocompleteComponent = /** @class */ (function () {
                function PlaceAutocompleteComponent(mapsAPILoader, ngZone) {
                    ...
                    this.mapsAPILoader.load().then(function () {
                        ...
                        autocomplete.addListener('place_changed', function () {
                            _this.ngZone.run(function () {
                                ...
                                _this.onPlaceChange.emit(place);
                            });
                        });
                    });
                };
            ...
            PlaceAutocompleteComponent.ctorParameters = function () { return [
